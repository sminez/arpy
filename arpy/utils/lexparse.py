...
class ARContext:
    ...
    def _initialise_vars(self):
        ...
        self._vars = {
            ...
            'B4': MultiVector(['p'] + _B, cfg=self.cfg),
            'T4': MultiVector(['0'] + _T, cfg=self.cfg),
            'A4': MultiVector([_h] + _A, cfg=self.cfg),
            'E4': MultiVector([_q] + _E, cfg=self.cfg),
            'Fp': MultiVector(['p'] + _B + _E, cfg=self.cfg),
            'Fpq': MultiVector(['p'] + _B + [_q] + _E, cfg=self.cfg),
            # Differentials
